---
name: 대규모 리팩토링 계획
overview: dev-guidelines.mdc 원칙에 따라 전체 코드베이스를 리팩토링하여 테스트 용이성, 관심사 분리, 모바일/데스크탑 독립성, DRY 원칙을 준수하는 구조로 전환합니다.
todos:
    - id: phase-0-prep
      content: "Phase 0: 준비 작업 - 테스트 안전망 확보 및 의존성 그래프 문서화"
      status: in_progress
    - id: phase-1-1-pure-fn
      content: "Phase 1-1: 순수 함수 통합 - shared/lib로 중복 함수 통합 (timeToMinutes 등)"
      status: pending
    - id: phase-1-2-common-ui
      content: "Phase 1-2: 공통 UI 추출 - SelectWithAdd, WorkFormFields 등 중복 UI 컴포넌트화"
      status: pending
    - id: phase-1-3-common-hooks
      content: "Phase 1-3: 공통 훅 추출 - useRecordCreation, useAutoCompleteOptions 등"
      status: pending
    - id: phase-1-4-features-lib
      content: "Phase 1-4: features/lib 분리 - 각 feature별 비즈니스 로직 순수 함수화"
      status: pending
    - id: phase-2-store
      content: "Phase 2: 스토어 분리 - useWorkStore 슬라이스 분리 및 액션 순수 함수화"
      status: pending
    - id: phase-3-component
      content: "Phase 3: 컴포넌트 분리 - DailyGanttChart, WorkRecordTable 등 거대 컴포넌트 분리"
      status: pending
    - id: phase-4-platform
      content: "Phase 4: 플랫폼 분리 - 모바일/데스크탑 완전 분리 및 공통 훅 추출"
      status: pending
    - id: phase-5-test
      content: "Phase 5: 테스트 보강 - 순수 함수, 훅, 컴포넌트 테스트 추가"
      status: pending
    - id: phase-6-cleanup
      content: "Phase 6: 정리 - components 폴더 제거 및 문서 업데이트"
      status: pending
---
...
1.  **Phase 1-1**: shared/lib 순수 함수 통합
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - `timeToMinutes`, `minutesToTime` → shared/lib/time 사용하도록 변경
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - `getSessionMinutes` → shared/lib/session 사용하도록 변경
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - 약 6개 파일에서 직접 정의된 함수 제거

2.  **Phase 1-2**: 공통 UI 컴포넌트 추출 (가장 효과적)

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - `SelectWithAdd.tsx` 생성 → 3개 파일에서 각 80줄씩 240줄 절감
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - `WorkFormFields.tsx` 생성 → 3개 파일에서 각 150줄씩 450줄 절감
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - **총 약 700줄 이상 중복 제거**

3.  **Phase 1-3**: 공통 훅 추출

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - `useRecordCreation.ts` → Desktop/MobileDailyPage 120줄 → 각 5줄
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - `useAutoCompleteOptions.ts` → 옵션 생성 로직 통합

4.  **Phase 2-1**: useWorkStore 슬라이스 분리

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - 2062줄 → 각 300-400줄 슬라이스로 분리

5.  **Phase 3-1, 3-2**: 거대 컴포넌트 분리

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - 공통 UI가 이미 추출되어 있으므로 분리 작업이 쉬워짐
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - DailyGanttChart: 2936줄 → (공통화 후) 약 2200줄 → 분리 후 각 200-300줄
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                - WorkRecordTable: 2743줄 → (공통화 후) 약 2000줄 → 분리 후 각 200-300줄

6.  **Phase 3-3~3-6**: 나머지 컴포넌트 분리

7.  **Phase 4**: 플랫폼 분리 (공통 훅 덕분에 중복 없음)

8.  **Phase 5, 6**: 테스트 및 정리
