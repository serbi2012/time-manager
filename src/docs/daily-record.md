...
| **완료 목록** | 완료된 작업 모달 열기            |
| **휴지통**    | 삭제된 작업 모달 열기            |
| **내역 보기** | 당일 작업 내역을 표로 열기       |

### 내역 보기

"내역 보기"를 누르면 당일 작업 내역이 표로 열려요. 메모장에 붙여넣지 않아도 이 화면에서 바로 필요한 부분만 골라 쓸 수 있어요.

| 동작                | 결과                              |
| ------------------- | --------------------------------- |
| 표를 드래그         | 원하는 범위를 그대로 선택해 복사  |
| 셀을 더블클릭       | 그 칸의 값만 클립보드에 복사      |
| 거래코드 칸을 클릭  | 코드 입력 (거래명마다 저장됨)     |
| "전체 복사" 버튼    | 표 전체를 시간 관리 양식으로 복사 |

표에는 작업명, 거래코드, 거래명, 시간, 카테고리, 비고가 담겨요.
