...
| **접기/펼치기** | 작업 목록을 접거나 펼칠 수 있어요 (설정 자동 저장) |
...
| 요소                | 설명                                                  |
| ------------------- | ----------------------------------------------------- |
| **페이지 제목**     | "일간 기록" 제목 + 설정/유저 아이콘                   |
| **날짜 네비게이션** | `< X월 X일 X요일 >` 형식, 좌/우 화살표로 하루씩 이동  |
| **주간 캘린더**     | 이번 주 7일을 한눈에 보고 탭으로 날짜 이동            |
| **타임라인 바**     | 간트차트 세그먼트 바 — 하루 작업 시간 분포 시각화     |
...
| 날짜 텍스트 길게 누르기  | 달력이 열려서 날짜를 바로 선택할 수 있어요          |
