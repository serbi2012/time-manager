...
| `Alt + Shift + S` | 서버에서 새로고침 | 서버의 최신 데이터 가져오기 (로그인 시) |

---

## 모달 단축키

모달(작업 추가/수정, 프리셋 추가 등) 내에서 사용하는 단축키입니다.

| 단축키 | 기능 | 설명 |
|--------|------|------|
| `F8` | 저장/추가 | 모달의 저장 또는 추가 버튼 실행 |

> **참고**: 모달 단축키는 입력 필드에서도 작동합니다.
...
단축키의 키 조합을 원하는 대로 변경할 수 있습니다:

1. 설정 > 단축키 탭
2. 변경하고 싶은 단축키 옆의 ✏️ 버튼 클릭
