 ...
 * 설정 모달 스타일 상수
 *
 * NOTE: Ant Design API constraints (styles={{ body }}, tabBarStyle, style on Modal/Tabs)
 * require CSSProperties objects. These cannot be replaced with Tailwind className.
 * Only constants used in Ant Design's style-slot APIs remain here.
 */
