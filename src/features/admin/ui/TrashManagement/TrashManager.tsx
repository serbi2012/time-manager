...
export function TrashManager({
  ...
  const handleBatchRestore = () => {
    ...
    setSelectedIds([]);
    message.success(`${selected_ids.length}개 항목이 복원되었습니다`);
  };
  ...
  const handleBatchDelete = () => {
    ...
    setSelectedIds([]);
    message.success(`${selected_ids.length}개 항목이 영구 삭제되었습니다`);
  };
  ...
  return (
    <div>
      ...
      <Row gutter={16} style={{ marginBottom: 16 }}>
        ...
        <Col span={8}>
          <Card size="small">
            <Statistic title="총 세션" value={stats.total_sessions} suffix="개" />
          </Card>
        </Col>
        <Col span={8}>
          <Card size="small">
