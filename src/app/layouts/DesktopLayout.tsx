        ...
        () => [
            {
                key: "/",
                icon: <HomeOutlined />,
                label: <Link to="/" style={menu_link_style}>일간 기록</Link>,
            },
            {
                key: "/weekly",
                icon: <CalendarOutlined />,
                label: <Link to="/weekly" style={menu_link_style}>주간 일정</Link>,
            },
            {
                key: "/suggestions",
                icon: <MessageOutlined />,
                label: <Link to="/suggestions" style={menu_link_style}>건의사항</Link>,
            },
            {
                key: "/guide",
                icon: <BookOutlined />,
                label: <Link to="/guide" style={menu_link_style}>사용 설명서</Link>,
            },
            ...(is_admin
                ? [{
                      key: "/admin",
                      icon: <ToolOutlined />,
                      label: <Link to="/admin" style={menu_link_style}>관리자</Link>,
                  }]
                : []),
        ],
        [is_admin]
