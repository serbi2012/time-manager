...
describe('시간 범위 조정', () => {
    describe('adjustTimeRangeToAvoidConflicts', () => {
        it('충돌 없으면 원본 반환', () => {
            const result = adjustTimeRangeToAvoidConflicts(
                100,
                200,
                [{ start: 300, end: 400 }]
            )
...
describe('날짜 유틸리티', () => {
    ...
    describe('isDateInRange', () => {
        it('범위 내 날짜면 true', () => {
            expect(isDateInRange('2026-01-19', '2026-01-15', '2026-01-25')).toBe(
                true
            )
        })

        it('시작 날짜와 같으면 true', () => {
            expect(isDateInRange('2026-01-15', '2026-01-15', '2026-01-25')).toBe(
                true
            )
        })

        it('종료 날짜와 같으면 true', () => {
            expect(isDateInRange('2026-01-25', '2026-01-15', '2026-01-25')).toBe(
                true
            )
        })

        it('범위 전이면 false', () => {
            expect(isDateInRange('2026-01-10', '2026-01-15', '2026-01-25')).toBe(
                false
            )
        })

        it('범위 후면 false', () => {
            expect(isDateInRange('2026-01-30', '2026-01-15', '2026-01-25')).toBe(
                false
            )
        })
    })
